                            ...
                            <div class="form-group">
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Username" name="subtotal" value="0.00" readonly="readonly">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-addon">IGV:</span>
                                        <input type="text" class="form-control" placeholder="Username" name="igv" value="0.00" readonly="readonly">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Username" name="total" value="0.00"readonly="readonly">
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php if(!empty($clientes)):?>
                            <?php foreach($clientes as $cliente):?>
                                <tr>
                                    ...
                                    <?php $datacliente = $cliente->id."*".$cliente->nombre."*".$cliente->num_documento."*".$cliente->telefono."*".$cliente->direccion;?>
                                    <td>
                        ...
                        <?php if(!empty($productos)):?>
                            <?php foreach($productos as $producto):?>
                                <tr>
                                    ...
                                    <?php $dataproducto = $producto->id."*".$producto->nombre."*".$producto->precio;?>
                                    <td>
                                        <button type="button" class="btn btn-success btn-check" value="<?php echo $dataproducto;?>"><span class="fa fa-check"></span></button>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                        <?php endif;?>
