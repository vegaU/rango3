        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2018-2019 <a href="https://adminlte.io">VEGA Software</a>.</strong> Todos los derechos reservados.
        </footer>
    </div>
    <!-- ./wrapper -->
<!-- jQuery 3 -->
...
$(document).ready(function () {
    ...
    $(".btn-view-producto").on("click", function(){
        ...
        html += "<p><strong>Stock:</strong>"+infoproducto[4]+"</p>"
